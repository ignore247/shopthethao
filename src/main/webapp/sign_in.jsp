    ...
    <body>
        <main class="auth">
            ...
            <div class="auth__intro d-md-none">
                <img src="./resources/img/auth/intro.svg" alt="" class="auth__intro-img" />
            ...
            <div class="auth__content">
                <div class="auth__content-inner">
                    <a href="./" class="logo">
                        <img src="./resources/icons/logo.svg" alt="grocerymart" class="logo__img" />
                    ...
                    <form action="./index-logined.html" class="form auth__form">
                        <div class="form__group">
                            <div class="form__text-input">
                                <input
                                    ...
                                    required
                                />
                                <img src="./resources/icons/message.svg" alt="" class="form__input-icon" />
                                <img src="./resources/icons/form-error.svg" alt="" class="form__input-icon-error" />
                            </div>
                        ...
                        <div class="form__group">
                            <div class="form__text-input">
                                <input
                                    ...
                                    minlength="6"
                                />
                                <img src="./resources/icons/lock.svg" alt="" class="form__input-icon" />
                                <img src="./resources/icons/form-error.svg" alt="" class="form__input-icon-error" />
                            </div>
                        ...
                        <div class="form__group form__group--inline">
                            ...
                            <a href="/shopthethao/reset-password" class="auth__link form__pull-right">Forgot password?</a>
                        </div>
                        <div class="form__group auth__btn-group">
                            ...
                            <button class="btn btn--outline auth__btn btn--no-margin">
                                <img src="./resources/icons/google.svg" alt="" class="btn__icon icon" />
                                Sign in with Google
                            </button>
                        </div>
                    </form>
                    ...
                    <p class="auth__text">
                        ...
                        <a href="/shopthethao/sign-up" class="auth__link auth__text-link">Sign Up</a>
                    </p>
                </div>
            </div>
        </main>
